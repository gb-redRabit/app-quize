<template>
  <Transition name="modal-fade">
    ...
    >
      <div
        class="relative bg-white dark:bg-gray-800 rounded-lg shadow-xl transform transition-all sm:my-8 w-full flex flex-col"
        style="max-height: 90vh; max-width: 64rem"
      >
        <div
